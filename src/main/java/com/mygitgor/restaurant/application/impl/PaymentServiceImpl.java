...
public class PaymentServiceImpl implements PaymentService {
   private final PaymentConfig config;
    ...
    @Override
    public PaymentResponse createStripePaymentLink(OrderEntity order) throws Exception {
    ...
    @Override
    public PaymentResponse createIdramPaymentLink(OrderEntity order) throws IOException, JSONException {
    ...
    @Override
    public PaymentResponse createEasyPayPaymentLink(OrderEntity order) throws IOException, JSONException {
        JSONObject requestData = new JSONObject();
        requestData.put("amount", order.getTotalAmount());
        requestData.put("currency", "AMD");
