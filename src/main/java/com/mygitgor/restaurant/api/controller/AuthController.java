...
import com.mygitgor.restaurant.api.controller.DTOs.request.RegisterRequest;
import com.mygitgor.restaurant.api.controller.DTOs.response.AuthResponse;
import com.mygitgor.restaurant.application.service.CustomerUserDetailsService;
...
public class AuthController {
     ...
     * Получает объект UserEntity из тела запроса.
     * Создает новый объект UserEntity на основе полученных данных.
